...
flowchart TD
    ...
    todo --> step1[Step1_SetupDiscussionWorkspace]
    step1 --> mkDir[Create_disussionsFolder_and_TimestampDir]
...
2. （如果需要）进行项目内探索。你需要探索
   ...
   请使用一个 expore 的 subagent，进行项目内探索。你的最终目的是为了在 research.md 中书写 `Project Findings` 的内容。
